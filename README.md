...
It was a weekly ritual for a member of the frontline management staff in the relevant department to spend at least half an hour filling out seven daysheets by hand. This process involves scanning the schedule spreadsheet over and over; picking out and typing all the names of employees on the relevant day, entering their name and shift hours into the daysheet, and ordering employees by role and start time. The alternative, using Kronos to generate daysheets, produces an inferior product. Leading multiple managers to manually create their own daysheets in Excel instead. 
